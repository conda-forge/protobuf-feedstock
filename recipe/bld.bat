...
..\bazel %OUTPUT_BASE% build --linkopt "/LIBPATH:%PREFIX%\libs" --action_env PYTHON_BIN_PATH=%PYTHON% --extra_toolchains=//py_toolchain:py_toolchain //python/dist:binary_wheel --define=use_fast_cpp_protos=true
if %ERRORLEVEL% neq 0 exit 1
